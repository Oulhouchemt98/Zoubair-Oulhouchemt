...
public class ControleurServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        else if (path.equals("/save.do") && request.getMethod().equals("POST"))
        {
            ...
            String fournisseurProduit=request.getParameter("fournisseurProduit");
            Produit p = metier.save(new Produit(nom,prix,fournisseurProduit));
        ...
        else if (path.equals("/update.do") )
        {
            ...
            p.setNomProduit(nom);
            p.setPrix(prix);
            p.setfournisseurProduit(fournisseurProduit);
